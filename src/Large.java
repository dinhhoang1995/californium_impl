...
public class Large extends CoapResource {
	...
	public void handleGET(CoapExchange exchange) {
		...
		BlockOption blkOpt = exchange.getRequestOptions().getBlock2();
		exchange.getRequestOptions().setBlock2(BlockOption.size2Szx(128), true/*blkOpt.isM()*/, blkOpt.getNum());
		exchange.getRequestOptions().setBlock1(BlockOption.size2Szx(128), true/*blkOpt.isM()*/, blkOpt.getNum());
